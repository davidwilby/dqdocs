...
There are a few ways to use deepQuest:
  1. Using Pip_, install from wheel, zip or tar using the gitHub URL.
  2. Using Pip_, install from local copy of wheel, zip or tar using the gitHub URL.
  3. git clone the gitHub repository and build via setup.py
